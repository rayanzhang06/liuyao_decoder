...
class DeepSeekClient(BaseLLMClient):
    ...
    def chat(self,
        ...
        logger.info(f"调用 DeepSeek API: model={model}, messages={len(messages)}")
        ...
        try:
            ...
            logger.info(f"DeepSeek API 响应成功: 耗时 {elapsed_time:.2f}s")
    ...
    def count_tokens(self, text: str) -> int:
        ...
        DeepSeek 与 OpenAI 使用类似的 token 计算方式
        ...
        try:
            ...
            # DeepSeek 使用 cl100k_base 编码器（与 GPT-4 相同）
